...
@section('css')
	<script type="text/javascript" src="{{route('web.main.home')}}/vendor/tcg/voyager/assets/js/vue1.min.js"></script>
    <link rel="stylesheet" href="{{route('web.main.home')}}/vendor/tcg/voyager/assets/css/media/media.css"/>
    <link rel="stylesheet" type="text/css" href="{{route('web.main.home')}}/vendor/tcg/voyager/assets/js/select2/select2.min.css">
    <link rel="stylesheet" href="{{route('web.main.home')}}/vendor/tcg/voyager/assets/css/media/dropzone.css"/>
...
@section('js')
<script src="{{route('web.main.home')}}/vendor/tcg/voyager/assets/js/media/dropzone.js"></script>
<script src="{{route('web.main.home')}}/vendor/tcg/voyager/assets/js/media/media.js"></script>
<script type="text/javascript">
    var media = new VoyagerMedia({
        baseUrl: "{{route('web.main.home')}}/administrador"
    });
    $(function () {
        media.init();
    });
